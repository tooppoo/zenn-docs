...
ある概念の本質を把握するには、その概念の定義、すなわち、何が本質的で何が付随的かを理解する必要がある。
...
ここでは2.がポイントで、「変更理由に基づいて分割せよ」という原典の基準を把握していれば、そもそも分割を回避できたか、あるいは「これは変更理由は一致していそうだが、～という理由で分離させておいた方が良い」というより高精度な判断・評価ができただろう。
