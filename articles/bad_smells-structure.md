...
ここで見いだされた構造および性質はいずれも、対象がコードあるいはモデル表現であるが故に発生したものには思われません。むしろこの構造および性質こそ「不吉なにおい」という認識の基礎的部分であり、これがコードやモデル表現という具体例に適用した一例が、「コードの不吉なにおい」「モデルの不吉なにおい」として位置づけられるように思えます。
