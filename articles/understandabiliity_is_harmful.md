...
とはいえ、本稿は単なる逆張りではない。自分なりの問題意識からこれらの概念に依拠するものへ、より正確には、「わかりやすい」「説得力のある」記事やテキストを書こうとするある種の態度にたいして、批判的吟味を試みることが本稿の目的だ。
...
値オブジェクトをimmutableにするという方法そのものは好意的に示されていることから、前2つの問題と比べて、この問題は比較的小さなものである。しかし、それでも「immutableを用いる代わりに、常にコピーを用いる」という選択肢（少なくとも、それも許容されていること）が隠蔽されているという事態が発生しているという点で、やはり出典を遡って初めて発見できる問題が隠れている。
...
わかりやすさと説得力は、必ずしも良い結果を招かない。その使い方次第では、かえって好ましからざる結果をもたらす。
問題は、その裏にある不透明性だ。
